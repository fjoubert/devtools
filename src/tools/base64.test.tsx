...
const encodedTestString = "ICFcIiMkJScoKSorLC0uLzAxMjM0NTY3ODk6Oz0/QEFCQ0RFRkdISUpLTE1OT1BRUlNUVVZXWFlaW1xcXV5fYOS4iua1tyvkuK3lnIs=";
...
describe('Base64', () => {
    ...
    // TODO TextEncoder is not in the default jest jsdom environment, fix that
    // test('encodes Base64', () => {
